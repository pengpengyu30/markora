...
PROJECTS = [
    ...
    ("24q4-markora-start","Start Laputa App Project","24q4","responsibility-learning","Done","Begin building Laputa — a custom Tauri desktop app for managing the personal knowledge vault."),
    ...
    ("25q1-markora-v1","Laputa App V1","25q1","responsibility-learning","Done","Ship the first working version of Laputa with 4-panel layout, inspector, and quick open."),
    ...
    ("25q2-markora-v2","Laputa App V2","25q2","responsibility-learning","Done","V2 with BlockNote editor, wiki-links autocomplete, and redesigned theme system."),
    ...
    ("25q4-markora-v3","Laputa App V3","25q4","responsibility-learning","Open","V3: mobile sync, AI note linking, and quick capture from menu bar."),
