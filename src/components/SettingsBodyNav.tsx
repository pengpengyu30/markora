import { Article, FolderOpen, GitBranch, Palette, type IconProps } from '@phosphor-icons/react'
...
export function SettingsBodyNav({ t }: SettingsBodyNavProps) {
  const items: SettingsNavItem[] = [
    ...
    { id: SETTINGS_SECTION_IDS.git, label: t('settings.autogit.title'), Icon: GitBranch },
