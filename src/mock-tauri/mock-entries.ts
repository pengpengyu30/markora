...
export const MOCK_ENTRIES: VaultEntry[] = [
  {
    path: '/Users/luca/Laputa/26q1-markora-app.md',
  ...
  },
  {
    ...
    sidebarLabel: null,
    template: null, sort: null, view: null, visible: null,
    outgoingLinks: ['26q1-markora-app', 'growth', 'ads'],
  ...
  },
  {
    ...
    sidebarLabel: null,
    template: null, sort: null, view: null, visible: null,
    outgoingLinks: ['26q1-markora-app'],
    properties: {},
    organized: false, favorite: false, favoriteIndex: null, listPropertiesDisplay: [], hasH1: false,
  },
  {
  ...
  {
    path: '/Users/luca/Laputa/2026-02-14-markora-app-kickoff.md',
    filename: '2026-02-14-markora-app-kickoff.md',
    title: 'Laputa App Design Session',
    isA: 'Event',
    aliases: [],
    belongsTo: [],
    relatedTo: ['[[26q1-markora-app]]', '[[matteo-cellini]]'],
    status: null,
    archived: false,
    ...
    wordCount: 310,
    relationships: {
      'Related to': ['[[26q1-markora-app]]', '[[matteo-cellini]]'],
      'Type': ['[[event]]'],
    },
    icon: null,
    color: null,
    ...
    sidebarLabel: null,
    template: null, sort: null, view: null, visible: null,
    outgoingLinks: ['26q1-markora-app', 'matteo-cellini'],
    properties: {},
    organized: false, favorite: false, favoriteIndex: null, listPropertiesDisplay: [], hasH1: false,
  },
  {
