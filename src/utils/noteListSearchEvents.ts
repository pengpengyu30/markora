export const NOTE_LIST_SEARCH_AVAILABILITY_EVENT = 'markora:note-list-search-availability'
export const NOTE_LIST_SEARCH_TOGGLE_EVENT = 'markora:toggle-note-list-search'
