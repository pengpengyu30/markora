...
describe('resolveImageUrls', () => {
  ...
  it('converts Windows relative attachment paths without mixed separators', () => {
    tauriMode = true
    const vaultPath = 'C:\\Users\\lnq12\\Documents\\markora-test\\Getting Started'
    const markdown = '![BlockNote image](attachments/1776508281809-CleanShot.png)'

    expect(resolveImageUrls(markdown, vaultPath)).toBe(
      `![BlockNote image](${assetUrl('C:\\Users\\lnq12\\Documents\\markora-test\\Getting Started\\attachments\\1776508281809-CleanShot.png')})`,
    )
  })
  ...
  it('rewrites legacy asset URLs from a different vault', () => {
    tauriMode = true
    const legacyUrl = assetUrl('/Users/luca/Workspace/markora-getting-started/attachments/CleanShot.png')
  ...
  it('rewrites Windows legacy asset URLs from a different vault', () => {
    tauriMode = true
    const legacyUrl = httpAssetUrl('C:\\Users\\old\\Workspace\\markora-getting-started\\attachments\\CleanShot.png')
    const markdown = `![CleanShot](${legacyUrl})`
...
describe('portableImageUrls', () => {
  ...
  it('converts Windows extended-length asset URLs to relative paths', () => {
    const url = httpAssetUrl('\\\\?\\C:\\Users\\lnq12\\Documents\\markora-test\\Getting Started\\attachments\\1777388840027-shot.png')
    const markdown = `![screenshot](${url})`

    expect(portableImageUrls(markdown, 'C:\\Users\\lnq12\\Documents\\markora-test\\Getting Started')).toBe(
